# Config for Powerlevel10k — Rainbow layout, colors tuned toward Tokyo Night (terminal theme).
# Derived from upstream config/p10k-rainbow.zsh; override local tweaks with `p10k configure`.
#
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%235F─╮'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%235F─┤'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%235F─╯'
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=22
